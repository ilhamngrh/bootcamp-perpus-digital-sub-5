        ...
        <table>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <button class="btn btn-sm btn-danger" type="button" id="button-reset">Reset</button>
                </td>
            </tr>
        </table>
    </form>
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach ($data as $b)
                                <tr class="row-data">
                                    ...
                                    <td>
                                        <button id="button-edit" class="button-edit btn btn-sm btn-warning"
                                            data-id="{{ $b['id'] }}" data-name="{{ $b['book_name'] }}"
